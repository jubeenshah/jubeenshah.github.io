...
_please, first, hack your way to answer._

The answer, awaits your searching, you just need to know where to look, or at least get good at [dorking](https://www.google.com/url?sa=t&source=web&rct=j&opi=89978449&url=https://www.exploit-db.com/google-hacking-database&ved=2ahUKEwij4amSxLOFAxW6EVkFHcMDBfAQFnoECDIQAQ&usg=AOvVaw2ggfEU6rzxJr01Vz1oha8X) for answers. 
...
The tool that you're using has the answers to the question. [RTFM](https://en.wikipedia.org/wiki/RTFM)... the manual, how I define it might be different than what people define it. But manual, for me, is anything that the tool covers. It is the forums, it is the pull requests, it is the code, irc channgels, mailing lists, it is the documentation that comes along with the code. 
