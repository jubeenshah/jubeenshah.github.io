...
2. **No commercial exploitation** — this content may not be used in any product, platform, or service for commercial purposes without written permission.

3. **Permission is available** — the Author is a reasonable person. If you have a legitimate use case and want to ask, ask. The answer might be yes.
